                ...
                <div id="myCarousel" class="carousel slide" data-ride="carousel">
                  ...
                  <div class="carousel-inner">
                    <div class="item active">
                      <img src="images/chinh-sach-1920x250.jpg" alt="Công Ty TNHH Thương Mại Lyan">
                    </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <!--<article class="hidden-xs hidden-sm col-md-4 col-lg-4">-->
                        <img src="images/chinh-sach-280x360.jpg" alt="Công Ty TNHH Thương Mại Lyan" class="img-responsive" id="banner-scroll"> 
                    <!--</article>--> 
                    <!-- end article-->
                </div> 
                <!-- end row-->
