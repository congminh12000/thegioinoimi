            	...
            	<?php do { ?>
           	    <div class="col-xs-12 co-sm-6 col-md-3 col-lg-3">
                	<div class="box_news4">
                        ...
                        <h4><a href="page_newsdetail.php?cat=<?php echo $row_rs_page_newsrelative['ID_menubar1']; ?>&id=<?php echo $row_rs_page_newsrelative['ID_news']; ?>" target="_self"><?php echo $row_rs_page_newsrelative['newstitle']; ?></a></h4>
