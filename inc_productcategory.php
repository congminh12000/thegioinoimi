...
?>
	...
	<?php do { ?>
	  <p><a href="product.php?cat=<?php echo $row_rs_productcategory['ID_menubar2']; ?>" target="_self"><i class="fa fa-star" aria-hidden="true"></i>&nbsp;&nbsp<?php echo $row_rs_productcategory['menubar2name']; ?></a></p>
