...
$rs_cnv_page = mysql_query($query_rs_cnv_page, $cnn_hoaly) or die(mysql_error());
$row_rs_cnv_page = mysql_fetch_assoc($rs_cnv_page);
$totalRows_rs_cnv_page = mysql_num_rows($rs_cnv_page);
?>
<!DOCTYPE html>
<html>
<head>
            ...
            <div class="col-xs-12 co-sm-12 col-md-8 col-lg-8">
                    ...
                    <div class="row box_news2">
                        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                          <a href="page_newsdetail.php?cat=<?php echo $row_rs_cnv_page['ID_menubar1']; ?>&id=<?php echo $row_rs_cnv_page['ID_news']; ?>" target="_self"><img src="images/news/<?php echo $row_rs_cnv_page['newsimg']; ?>" alt="Công Ty TNHH Thương Mại Lyan" class="img-responsive"></a>
                          </div>
                        <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
                          <h4><a href="page_newsdetail.php?cat=<?php echo $row_rs_cnv_page['ID_menubar1']; ?>&id=<?php echo $row_rs_cnv_page['ID_news']; ?>" target="_self"><?php echo $row_rs_cnv_page['newstitle']; ?></a></h4>
                          <span class="line3"></span>
                          <p><?php echo $row_rs_cnv_page['shortdes']; ?></p>
                          <p><a href="page_newsdetail.php?cat=<?php echo $row_rs_cnv_page['ID_menubar1']; ?>&id=<?php echo $row_rs_cnv_page['ID_news']; ?>" target="_self">Chi tiết <i class="fa fa-chevron-right" aria-hidden="true"></i></a></p>
                          </div> 
                        </div> <!-- row box_news2-->
                      <?php } while ($row_rs_cnv_page = mysql_fetch_assoc($rs_cnv_page)); ?>
            </div> <!-- end col-->
