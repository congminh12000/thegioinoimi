...
// Filter
$tfi_listcopyright1 = new TFI_TableFilter($conn_cnn_hoaly, "tfi_listcopyright1");
...
$tfi_listcopyright1->addColumn("copyright.businessphonenumber", "STRING_TYPE", "businessphonenumber", "%");
...
$tso_listcopyright1->addColumn("copyright.businessphonenumber");
...
$query_rscopyright1 = "SELECT copyright.businessname, copyright.businessemail, copyright.businessphonenumber, copyright.ID_copyright FROM copyright WHERE {$NXTFilter_rscopyright1} ORDER BY {$NXTSort_rscopyright1}";
$query_limit_rscopyright1 = sprintf("%s LIMIT %d, %d", $query_rscopyright1, $startRow_rscopyright1, $maxRows_rscopyright1);
$rscopyright1 = mysql_query($query_limit_rscopyright1, $cnn_hoaly) or die(mysql_error());
...
<style type="text/css">
  ...
  .KT_col_businessphonenumber {width:100%; overflow:hidden;}
</style>
</head>
              ...
              <table cellpadding="2" cellspacing="0" class="KT_tngtable">
                <thead>
                  <tr class="KT_row_order">
                    ...
                    <th id="businessname" class="KT_sorter KT_col_businessname <?php echo $tso_listcopyright1->getSortIcon('copyright.businessname'); ?>"> <a href="<?php echo $tso_listcopyright1->getSortLink('copyright.businessname'); ?>">Tên công ty</a> </th>
                    ...
                    <th id="businessphonenumber" class="KT_sorter KT_col_businessphonenumber <?php echo $tso_listcopyright1->getSortIcon('copyright.businessphonenumber'); ?>"> <a href="<?php echo $tso_listcopyright1->getSortLink('copyright.businessphonenumber'); ?>">Điện thoại</a> </th>
                    <th>&nbsp;</th>
                  </tr>
                  <?php 
...
?>
                    <tr class="KT_row_filter">
                      <td>&nbsp;</td>
                      <td><input type="text" name="tfi_listcopyright1_businessname" id="tfi_listcopyright1_businessname" value="<?php echo KT_escapeAttribute(@$_SESSION['tfi_listcopyright1_businessname']); ?>" size="20" maxlength="168" /></td>
                      <td><input type="text" name="tfi_listcopyright1_businessemail" id="tfi_listcopyright1_businessemail" value="<?php echo KT_escapeAttribute(@$_SESSION['tfi_listcopyright1_businessemail']); ?>" size="20" maxlength="168" /></td>
                      <td><input type="text" name="tfi_listcopyright1_businessphonenumber" id="tfi_listcopyright1_businessphonenumber" value="<?php echo KT_escapeAttribute(@$_SESSION['tfi_listcopyright1_businessphonenumber']); ?>" size="20" maxlength="26" /></td>
...
?>
                  ...
                  <?php if ($totalRows_rscopyright1 > 0) { // Show if recordset not empty ?>
                    <?php do { ?>
                      <tr class="<?php echo @$cnt1++%2==0 ? "" : "KT_even"; ?>">
                        ...
                        <td><div class="KT_col_businessname"><?php echo KT_FormatForList($row_rscopyright1['businessname'], 38); ?></div></td>
                        <td><div class="KT_col_businessemail"><?php echo KT_FormatForList($row_rscopyright1['businessemail'], 26); ?></div></td>
                        <td><div class="KT_col_businessphonenumber"><?php echo KT_FormatForList($row_rscopyright1['businessphonenumber'], 20); ?></div></td>
                        <td><a class="KT_edit_link" href="form_banquyen.php?ID_copyright=<?php echo $row_rscopyright1['ID_copyright']; ?>&amp;KT_back=1"><?php echo NXT_getResource("edit_one"); ?></a> <a class="KT_delete_link" href="#delete"><?php echo NXT_getResource("delete_one"); ?></a></td>
                      </tr>
          ...
          ?>
              ...
              <div class="KT_bottombuttons">
                ...
                <a class="KT_additem_op_link" href="form_banquyen.php?KT_back=1" onclick="return nxt_list_additem(this)"><?php echo NXT_getResource("add new"); ?></a> </div>
            </form>
          </div>
