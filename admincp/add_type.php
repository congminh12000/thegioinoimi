...
//var_dump($_POST);die;
    ...
    if (empty($tm2Name)) {
        ...
        $strQuery = "SELECT * FROM type_menubar2 WHERE tm2_deleted = 0 AND tm2_name = '{$tm2Name}'";
        $query = mysql_query($strQuery);
    ...
    if (empty($arrError)) {
        ...
        $strQuery = "INSERT INTO type_menubar2(ID_menubar2, tm2_name, tm2_status, parent_id) VALUES({$IDmenubar2}, '{$tm2Name}', {$tm2Status}, {$parentId})";
        $query = mysql_query($strQuery);
                            ...
                            <div class="KT_tnglist">
                                <form class="form-horizontal" action="" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="tm2_name" placeholder="">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="form-control select-parent" name="parent_id">
                                                ...
                                                <?php foreach ($arrParentType as $type): ?>
                                                    <option value="<?php echo $type['ID_type_menubar2']; ?>"><?php echo $type['tm2_name']; ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-sm-10">
                                            <select class="form-control" name="ID_menubar2">
                                                ...
                                                <?php foreach ($arrMenubar2 as $item): ?>
                                                    <option value="<?php echo $item['ID_menubar2']; ?>"><?php echo $item['menubar2name']; ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        </div>
                                    </div>
