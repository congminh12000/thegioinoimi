...
?>
                    <tr class="KT_row_filter">
                      ...
                      <td><select name="tfi_listproduct2_ID_danhmuc1" id="tfi_listproduct2_ID_danhmuc1">
                        <option value="" <?php if (!(strcmp("", @$_SESSION['tfi_listproduct2_ID_danhmuc1']))) {echo "SELECTED";} ?>><?php echo NXT_getResource("None"); ?></option>
                        <?php
do {  
?>
                        <option value="<?php echo $row_Recordset1['ID_menubar1']?>"<?php if (!(strcmp($row_Recordset1['ID_menubar1'], @$_SESSION['tfi_listproduct2_ID_danhmuc1']))) {echo "SELECTED";} ?>><?php echo $row_Recordset1['menubar1name']?></option>
                        <?php
...
?>
                      ...
                      <td><select name="tfi_listproduct2_ID_danhmuc2" id="tfi_listproduct2_ID_danhmuc2">
                        <option value="" <?php if (!(strcmp("", @$_SESSION['tfi_listproduct2_ID_danhmuc2']))) {echo "SELECTED";} ?>><?php echo NXT_getResource("None"); ?></option>
                        <?php
do {  
?>
                        <option value="<?php echo $row_Recordset2['ID_menubar2']?>"<?php if (!(strcmp($row_Recordset2['ID_menubar2'], @$_SESSION['tfi_listproduct2_ID_danhmuc2']))) {echo "SELECTED";} ?>><?php echo $row_Recordset2['menubar2name']?></option>
                        <?php
