<ul class="menuside">
          ...
          <li><a href="list_sanpham.php" target="_self"><i class="fa fa-globe" aria-hidden="true"></i>&nbsp;&nbsp;Sản phẩm</a></li>
          <li><a href="list_lienhe.php" target="_self"><i class="fa fa-bars" aria-hidden="true"></i>&nbsp;&nbsp;Liên hệ</a></li>
          <li><a href="list_taikhoan.php" target="_self"><i class="fa fa-key" aria-hidden="true"></i>&nbsp;&nbsp;Tài khoản</a></li>
          <li><a href="list_banquyen.php" target="_self"><i class="fa fa-cogs" aria-hidden="true"></i>&nbsp;&nbsp;Copyright</a></li>  
</ul>