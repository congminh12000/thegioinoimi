...
// endif Conditional region1
                                        ...
                                        <table cellpadding="2" cellspacing="0" class="KT_tngtable">
                                            <tr>
                                                ...
                                                <td colspan="2"><select name="ID_danhmuc1_<?php echo $cnt1; ?>" id="ID_danhmuc1_<?php echo $cnt1; ?>">
                                                        ...
                                                        do {
                                                            ?>
                                                            <option value="<?php echo $row_rs_danhmuc1['ID_menubar1'] ?>"<?php
                                                            if (!(strcmp($row_rs_danhmuc1['ID_menubar1'], $row_rsproduct['ID_danhmuc1']))) {
                                                                echo "SELECTED";
                                                            }
                                                            ?>><?php echo $row_rs_danhmuc1['menubar1name'] ?></option>
                                                                    <?php
            ...
            CKEDITOR.replace('productdetail_<?php echo $cnt1; ?>', {extraPlugins: 'imageuploader'});
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="2"><input  <?php
                                                    if (!(strcmp(KT_escapeAttribute($row_rsproduct['productapproval']), "1"))) {
                                                        echo "checked";
                                                    }
                                                    ?> type="checkbox" name="productapproval_<?php echo $cnt1; ?>" id="productapproval_<?php echo $cnt1; ?>" value="1" />
