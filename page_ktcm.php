...
$classPaginator = new Paginator($query_rs_ktcm_page);
                ...
                <div id="myCarousel" class="carousel slide" data-ride="carousel">
                  ...
                  <div class="carousel-inner">
                    <div class="item active">
                      <img src="images/kien-thuc-chuyen-mon-1920x250.jpg" alt="Công Ty TNHH Thương Mại Lyan">
                    </div>
        ...
        <div class="page_news">
            <div class="container">
                <div class="row">
                    ...
                    <img src="images/kien-thuc-chuyen-mon-280x360.jpg" alt="Công Ty TNHH Thương Mại Lyan" class="img-responsive" id="banner-scroll"> 
                    <!--</article>--> 
                    <!-- end article-->
                </div> 
                <!-- end row-->
