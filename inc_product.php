...
?>
					...
					<?php do { ?>
					  <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 text-center productbox">
					    ...
					    <p><?php echo $row_rs_product['productprice']; ?>đ</p>
					    <p><a href="productdetail.php?cat=<?php echo $row_rs_product['ID_danhmuc2']; ?>&amp;id=<?php echo $row_rs_product['ID_product']; ?>" target="_self">Chi tiết</a>&nbsp;&nbsp;&nbsp;<a href="#" target="_self">Giỏ hàng</a></p>
